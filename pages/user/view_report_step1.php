      ...
      <div class="col-12 mb-4">
        <div class="row mb-3 align-items-center">
          ...
          <div class="col-12 col-lg-6 text-lg-end">
            <a href="edit1.php?id=<?php echo $getid; ?>" class="btn btn-outline-info custom-button">
            ...
            <ul class="dropdown-menu" aria-labelledby="exportDropdown">
              <li><a class="dropdown-item" href="export1.php?id=<?php echo $getid; ?>&type=word"><i class="bx bxs-file-export me-2"></i> Export to Word</a></li>
        ...
        <div class="content">
          ...
          foreach ($headlines as $index => $headline) {
            ...
            $dataLine = preg_replace('/^(&nbsp;|\s)+/', '', nl2br(htmlspecialchars_decode($data[$index] ?? '')));
          ?>
