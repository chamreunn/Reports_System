...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="assets/vendor/css/rtl/theme-default.css"
    ...
    <div id="template-customizer" class="invert-bg-white" style="visibility: visible"> <a href="javascript:void(0)"
        ...
        <div class="p-4 m-0 lh-1 border-bottom template-customizer-header position-relative py-3">
            ...
            <div class="d-flex align-items-center gap-2 position-absolute end-0 top-0 mt-4 me-3"> <a
                    ...
                    data-bs-placement="bottom" title="Reset Customizer"><i class="bx bx-refresh fs-4"></i><span
        ...
        <div class="template-customizer-inner pt-4">
            <div class="template-customizer-theming">
                ...
                <div class="m-0 px-4 pt-3 template-customizer-themes w-100"> <label for="customizerTheme"
                        ...
                        <div class="col-4 px-2">
                            <div class="form-check custom-option custom-option-icon mb-0 checked">
                                <label class="form-check-label custom-option-content p-0"
                                    ...
                                    <span class="custom-option-body mb-0">
                                        <img src="assets/img/customizer/default.svg" alt="Default"
                                            class="img-fluid scaleX-n1-rtl">
                                    </span>
                        ...
                        <div class="col-4 px-2">
                            <div class="form-check custom-option custom-option-icon mb-0">
                                <label class="form-check-label custom-option-content p-0"
                                    ...
                                    <span class="custom-option-body mb-0">
                                        <img src="assets/img/customizer/border.svg" alt="Bordered"
                                            class="img-fluid scaleX-n1-rtl">
                                    </span>
                                    <input name="themeRadios" class="form-check-input d-none" type="radio"
                        ...
                        <div class="col-4 px-2">
                            <div class="form-check custom-option custom-option-icon mb-0">
                                <label class="form-check-label custom-option-content p-0"
                                    ...
                                    <span class="custom-option-body mb-0">
                                        <img src="assets/img/customizer/semi-dark.svg" alt="Semi Dark"
                                            class="img-fluid scaleX-n1-rtl">
                                    </span>
                                    <input name="themeRadios" class="form-check-input d-none" type="radio"
            ...
            <div class="template-customizer-layout">
                ...
                <div class="m-0 px-4 pb-3 d-block template-customizer-layouts"> <label for="customizerStyle"
                        ...
                        <div class="col-4 px-2">
                            <div class="form-check custom-option custom-option-icon mb-0 checked">
                                <label class="form-check-label custom-option-content p-0" for="layoutsRadiosexpanded">
                                    <span class="custom-option-body mb-0">
                                        <img src="assets/img/customizer/expanded.svg" alt="Expanded"
                                            class="img-fluid scaleX-n1-rtl">
                                    </span>
                        ...
                        <div class="col-4 px-2">
                            <div class="form-check custom-option custom-option-icon mb-0">
                                <label class="form-check-label custom-option-content p-0" for="layoutsRadioscollapsed">
                                    <span class="custom-option-body mb-0">
                                        <img src="assets/img/customizer/collapsed.svg" alt="Collapsed"
                                            class="img-fluid scaleX-n1-rtl">
                                    </span>
                                    <input name="layoutsRadios" class="form-check-input d-none" type="radio"
                ...
                <div class="m-0 px-4 pb-3 template-customizer-layoutNavbarOptions w-100"> <label for="customizerNavbar"
                        ...
                        <div class="col-4 px-2">
                            <div class="form-check custom-option custom-option-icon mb-0">
                                <label class="form-check-label custom-option-content p-0"
                                    ...
                                    <span class="custom-option-body mb-0">
                                        <img src="assets/img/customizer/sticky.svg" alt="Sticky"
                                            class="img-fluid scaleX-n1-rtl">
                                    </span>
                        ...
                        <div class="col-4 px-2">
                            <div class="form-check custom-option custom-option-icon mb-0 checked">
                                <label class="form-check-label custom-option-content p-0"
                                    ...
                                    <span class="custom-option-body mb-0">
                                        <img src="assets/img/customizer/static.svg" alt="Static"
                                            class="img-fluid scaleX-n1-rtl">
                                    </span>
                                    <input name="navbarOptionRadios" class="form-check-input d-none" type="radio"
                                        value="static" id="navbarOptionRadiosstatic" checked="checked">
                                </label>
                            </div>
                            <label class="form-check-label small text-nowrap"
                        ...
                        <div class="col-4 px-2">
                            <div class="form-check custom-option custom-option-icon mb-0">
                                <label class="form-check-label custom-option-content p-0"
                                    ...
                                    <span class="custom-option-body mb-0">
                                        <img src="assets/img/customizer/hidden.svg" alt="Hidden"
                                            class="img-fluid scaleX-n1-rtl">
                                    </span>
                                    <input name="navbarOptionRadios" class="form-check-input d-none" type="radio"
                ...
                <div class="m-0 px-4 pb-3 template-customizer-content w-100"> <label for="customizerContent"
                        ...
                        <div class="col-4 px-2">
                            <div class="form-check custom-option custom-option-icon mb-0">
                                <label class="form-check-label custom-option-content p-0" for="contentRadioIconcompact">
                                    <span class="custom-option-body mb-0">
                                        <img src="assets/img/customizer/compact.svg" alt="Compact"
                                            class="img-fluid scaleX-n1-rtl">
                                    </span>
                                    <input name="contentRadioIcon" class="form-check-input d-none" type="radio"
                                        value="compact" id="contentRadioIconcompact">
                                </label>
                            </div>
                            <label class="form-check-label small text-nowrap"
                        ...
                        <div class="col-4 px-2">
                            <div class="form-check custom-option custom-option-icon mb-0 checked">
                                <label class="form-check-label custom-option-content p-0" for="contentRadioIconwide">
                                    <span class="custom-option-body mb-0">
                                        <img src="assets/img/customizer/wide.svg" alt="Wide"
                                            class="img-fluid scaleX-n1-rtl">
                                    </span>
                                    <input name="contentRadioIcon" class="form-check-input d-none" type="radio"
                                        value="wide" id="contentRadioIconwide" checked="checked">
                                </label>
                            </div>
